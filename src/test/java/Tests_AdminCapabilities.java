...
public class Tests_AdminCapabilities extends BaseTestClass {
    ...
    public void startTest() {
        ...
        // com.aventstack v5: createTest() replaces startTest()
        logger = extent.createTest("The first test of flink has started");
    ...
    public void Vreify_Admin_See_Pending_Posts() {
        ...
        logger = extent.createTest("The test session has started");
    }
    ...
    public void Vreify_Admin_See_Pending_MemberApproval() {
        ...
        logger.log(Status.PASS, "Admin see pending member approval");
    }
    ...
    public void Vreify_Admin_MemberApproval() {
        ...
        logger.log(Status.PASS, "Admin approved member approval");
    }
    ...
    public void Vreify_Admin_PostApproval() {
        ...
        logger.log(Status.PASS, "Admin approved a post");
    }
    ...
    public void Vreify_Admin_Preapprove_MemberApproval() {
        ...
        logger.log(Status.PASS, "Admin pre approved a member");
    }

    @Test(priority = 5, description = "Verify that admin can decline a member successfully")
    public void Vreify_Admin_Decline_MemberApproval() {
        ...
        logger.log(Status.PASS, "Admin decline a member approval");
    }
    ...
    public void Vreify_Admin_Can_Ban_Member() {
        ...
        logger.log(Status.PASS, "Admin decline member approval");
    }
    ...
    public void Vreify_Admin_Can_ApproveAll_member_request() {
        ...
        logger.log(Status.PASS, "Admin approved all member");
    }
    ...
    public void Vreify_Admin_Can_ApproveAll_post_request() {
        ...
        logger.log(Status.PASS, "Admin approved all post");
    }
    ...
    public void Vreify_Admin_Can_DeclineAll_member_request() {
        ...
        logger.log(Status.PASS, "Admin declined all member");
    }
    ...
    public void Vreify_Admin_Can_DeclineAll_post_request() {
        ...
        logger.log(Status.PASS, "Admin declined all post");
    }
    ...
    public void Vreify_Admin_Can_delete_post() {
        ...
        logger.log(Status.PASS, "Admin deleted a post");
    }

    @AfterClass
    public void teardown() {
        driver.quit();
        logger.log(Status.INFO, "Admin related Test suite run complete");
    }
}
